...
void add_sub(int *counter, struct abonent *cat, int *free)
{
    int index;
    char ename[10];
...
void delete_sub(int *counter, struct abonent *cat, int *free){
    char ename[10];
    int flag;
    printf("Enter name(less than 10 characters):\n");
    scanf("%s", ename);
...
void search_sub(struct abonent *cat){
    char ename[10];
    int flag;
    printf("Enter name(less than 10 characters):\n");
            scanf("%s", ename);
...
void display_all(struct abonent *cat, int *free){
    for (int i = 0; i < 100; i++)
            {
...
int main()
{
    ...
    while (1)
    {
        ...
        {
        case 1:
            add_sub(&counter, cat, free);

            break;
        case 2:
            delete_sub(&counter, cat, free);
            break;
        case 3:
            search_sub(cat);
            break;
        case 4:
            display_all(cat, free);
            break;
        case 5:
